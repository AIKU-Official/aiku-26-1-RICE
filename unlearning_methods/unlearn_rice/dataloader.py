"""Dataset and collator for configurable forget+RMU unlearning."""
...
class NPORMUForgetDataset(Dataset):
    """Return paired forget/retain examples for forget+RMU training."""

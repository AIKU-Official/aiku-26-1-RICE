"""Dataset and collator for WMDP-style RMU on TOFU QA pairs."""
...
class RMUForgetDataset(Dataset):
    """Return paired forget/retain examples for RMU training."""
